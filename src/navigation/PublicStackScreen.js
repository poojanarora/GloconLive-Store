...
import { Login, CheckApplicationStatus, ApplicationStatus } from '../screens/index.js';
...
const PublicStackScreen = ({ navigation }) => {
    ...
    return(
        ...
        >
            ...
            <PublicStack.Screen name="CheckApplicationStatus" component={CheckApplicationStatus} />
            <PublicStack.Screen 
